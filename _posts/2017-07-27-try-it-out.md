...
For a minimalist and autostarting page, we suggest the [go page]({{site.baseurl}}go)
...
<input id="prime_button" onclick="workload(false);" type="image" src="{{site.baseurl}}/assets/images/icon.png" width="auto" height="200em"/>
